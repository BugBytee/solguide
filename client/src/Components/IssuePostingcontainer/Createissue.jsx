...
import "./Issue.css"
import { db, CollectionID, account, storage, DatabaseID, BucketID } from "../../Service/Appwritesdkconfig.js"
...
const Createissue = () => {
  ...
  const sendPictostorage = async () => {
    try {
      ...
      // const promise = await storage.createFile(BucketID, ID.unique, document.getElementById('uploader').files[0]);
